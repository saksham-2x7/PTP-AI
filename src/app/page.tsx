...
import { auth, googleProvider, githubProvider, signInWithPopup, signOut } from '@/lib/data/db';
import { onAuthStateChanged, User } from 'firebase/auth';
import { Button } from '@/components/ui/button';
import { Textarea } from '@/components/ui/textarea';
import { Card, CardHeader, CardTitle, CardContent } from '@/components/ui/card';
import { Badge } from '@/components/ui/badge';
import { AlertTriangle, Activity, Server, Ambulance, UploadCloud, FileAudio, FileImage, ShieldCheck, ShieldAlert, CheckCircle2, Zap, LogOut, Github } from 'lucide-react';
            ...
            <div className="min-h-screen bg-neutral-950 flex flex-col items-center justify-center font-sans selection:bg-red-900/50 p-4">
                <Card className="bg-neutral-900/50 border-neutral-800 shadow-2xl p-8 max-w-md w-full text-center">
                    ...
                    <div className="space-y-4">
                        ...
                        <Button onClick={() => handleLogin(githubProvider)} className="w-full bg-[#24292e] hover:bg-[#1b1f23] text-white font-bold h-12 flex items-center gap-3 justify-center border border-neutral-700">
